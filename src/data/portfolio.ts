...
export const COPY = {
  heroLine1: 'My Name Is Muhammad Bilal Khan',
  heroLine2Before: 'I am an',
  heroLine2Accent: 'Artistic',
  heroLine2After: 'Web Developer.',
  windowAbout1: 'I am based in Alborz, Iran with over 5 years of',
  windowAbout2: 'professional experience. I have built visually',
  windowAbout3: 'high-scale websites for companies worldwide.',
  enter: 'Enter',
  scrollExplore: 'Scroll to Explore',
  tapProject: 'To learn more, tap on a project.',
  myWork: 'My Work',
  hobbiesMovies: 'Movies and TV Shows are some of my favorite things to watch when I\'m free.',
...
export const projects: Project[] = [
  {
    ...
    tags: ['HTML', 'CSS', 'Javascript', 'Reactjs', 'Threejs', 'GSAP', 'Blender', 'GLSL Shaders'],
  ...
  },
  {
    ...
    tags: ['HTML', 'CSS', 'Javascript', 'Reactjs', 'Threejs', 'GSAP', 'GLSL Shaders'],
  ...
  },
  {
    ...
    tags: ['HTML', 'CSS', 'Javascript', 'Reactjs', 'Threejs', 'React Three Fiber', 'Blender', 'GSAP'],
